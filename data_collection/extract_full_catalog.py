#!/usr/bin/env python3
"""
Extract FULL course information directly from catalog pages
...
def extract_courses_from_catalog(url: str, expected_dept: str) -> List[Dict]:
    ...
    while i < len(lines):
        ...
        if match:
            ...
            # Extract title (everything before "Fall:", "Spring:", units info, etc.)
            # Split on common patterns that come after title
            title_parts = re.split(r'\s+(Fall|Spring|Summer|Fall and Spring|Summer and Fall):', title_and_rest)
...
def main():
    print("=" * 80)
    print("CMU Course Catalog - FULL COURSE EXTRACTION")
    print("=" * 80)
    ...
    # Save to file
    output_file = "data/courses_full.json"
